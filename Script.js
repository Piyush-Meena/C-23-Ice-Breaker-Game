...
function addBlocks() {
  for(var i=0;i<blocks;i++) {
    ...
    b.style.backgroundColor = 'hsla(240deg,100%,'+(((Math.floor(i/blocksPer))*10)+50)+'%, .8)'
...
function checkHighScore() {
  if(localStorage.getItem('ice-breaker-score')) {
    if(score > localStorage.getItem('ice-breaker-score')) {
      ...
      document.querySelector('#start_message p span').innerHTML = localStorage.getItem('ice-breaker-score')
    }
    document.querySelector('#start_message p span').innerHTML = localStorage.getItem('ice-breaker-score')
  } else {
